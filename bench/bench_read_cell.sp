...
benchmark("cell lookup: small, direct, early", 10, 1000, small_direct_early)
benchmark("cell lookup: medium, direct, early", 10, 1000, medium_direct_early)
benchmark("cell lookup: medium, direct, late", 10, 1000, medium_direct_late)
benchmark("cell lookup: large, direct, early", 10, 1000, large_direct_early)
benchmark("cell lookup: large, direct, mid", 10, 1000, large_direct_mid)
benchmark("cell lookup: large, direct, late", 10, 1000, large_direct_late)
benchmark("cell lookup: deep ancestor", 10, 1000, ancestor)
benchmark("cell lookup: small, direct, early, polymorphic", 10, 100, small_direct_early_poly)
benchmark("cell lookup: medium, direct, early, polymorphic", 10, 100, medium_direct_early_poly)
benchmark("cell lookup: medium, direct, late, polymorphic", 10, 100, medium_direct_late_poly)
benchmark("cell lookup: large, direct, early, polymorphic", 10, 100, large_direct_early_poly)
benchmark("cell lookup: large, direct, mid, polymorphic", 10, 100, large_direct_mid_poly)
benchmark("cell lookup: large, direct, late, polymorphic", 10, 100, large_direct_late_poly)
benchmark("cell lookup: deep ancestor, polymorphic", 10, 100, ancestor_poly)
