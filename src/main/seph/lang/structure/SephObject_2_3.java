...
public class SephObject_2_3 extends SephObjectStructure {
    ...
    public SephObject_2_3(IPersistentMap meta, SephObject parent0, SephObject parent1, String selector0, SephObject cell0, String selector1, SephObject cell1, String selector2, SephObject cell2) {
        super(meta);
