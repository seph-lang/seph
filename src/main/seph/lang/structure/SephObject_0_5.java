...
public class SephObject_0_5 extends SephObjectStructure {
    ...
    public SephObject_0_5(IPersistentMap meta, String selector0, SephObject cell0, String selector1, SephObject cell1, String selector2, SephObject cell2, String selector3, SephObject cell3, String selector4, SephObject cell4) {
        super(meta);
