...
public class SephObject_3_2 extends SephObjectStructure {
    ...
    public SephObject_3_2(IPersistentMap meta, SephObject parent0, SephObject parent1, SephObject parent2, String selector0, SephObject cell0, String selector1, SephObject cell1) {
        super(meta);
