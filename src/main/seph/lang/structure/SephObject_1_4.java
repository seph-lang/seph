...
public class SephObject_1_4 extends SephObjectStructure {
    ...
    public SephObject_1_4(IPersistentMap meta, SephObject parent0, String selector0, SephObject cell0, String selector1, SephObject cell1, String selector2, SephObject cell2, String selector3, SephObject cell3) {
        super(meta);
