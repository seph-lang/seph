...
public class SephObject_4_2 extends SephObjectStructure {
    ...
    public SephObject_4_2(IPersistentMap meta, SephObject parent0, SephObject parent1, SephObject parent2, SephObject parent3, String selector0, SephObject cell0, String selector1, SephObject cell1) {
        super(meta);
