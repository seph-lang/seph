...
public class SephObject_3_n extends SephObjectStructure {
    ...
    public SephObject_3_n(IPersistentMap meta, SephObject parent0, SephObject parent1, SephObject parent2, IPersistentMap cells) {
        super(meta);
