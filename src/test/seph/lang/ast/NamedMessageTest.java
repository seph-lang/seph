...
public class NamedMessageTest {
    ...
    public void is_a_seph_object() {
        assertTrue("A NamedMessage should be a SephObject", NamedMessage.create(null, null, null, null, 0, 0) instanceof SephObject);
    }

    @Test
    public void is_a_message() {
        assertTrue("A NamedMessage should be a Message", NamedMessage.create(null, null, null, null, 0, 0) instanceof Message);
    }

    @Test
    public void has_a_next_pointer() {
        Message one = NamedMessage.create(null, null, null, null, 0, 0);
        NamedMessage two = NamedMessage.create(null, null, one, null, 0, 0);
        assertSame(one, two.next());
    }

    @Test
    public void has_a_name() {
        NamedMessage msg = NamedMessage.create("foo", null, null, null, 0, 0);
        assertEquals("foo", msg.name());
    }

    @Test
    public void has_a_list_of_arguments() {
        IPersistentList args = PersistentList.create(Arrays.<Message>asList(NamedMessage.create(null, null, null, null, 0, 0), NamedMessage.create(null, null, null, null, 0, 0)));
        NamedMessage msg = NamedMessage.create(null, args, null, null, 0, 0);
        assertSame(args, msg.arguments());
    }

    @Test
    public void arguments_return_an_empty_array_if_given_null() {
        NamedMessage msg = NamedMessage.create(null, null, null, null, 0, 0);
        assertEquals(PersistentList.EMPTY, msg.arguments());
    }

    @Test
    public void with_next_returns_a_new_object_with_the_same_name() {
        NamedMessage msg = NamedMessage.create("fox", null, null, null, 0, 0);
    ...
    public void with_next_returns_a_new_object_with_the_same_arguments() {
        ...
        NamedMessage msg = NamedMessage.create(null, expected, null, null, 0, 0);
        assertSame(expected, msg.withNext(null).arguments());
    }

    @Test
    public void with_next_returns_a_new_object_with_a_new_next() {
        Message expected = NamedMessage.create(null, null, null, null, 0, 0);
        NamedMessage msg = NamedMessage.create(null, null, null, null, 0, 0);
