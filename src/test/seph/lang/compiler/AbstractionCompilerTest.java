...
public class AbstractionCompilerTest {
    ...
    public void ensure_generated_argument_method_can_return_the_argument_code_unevaluated() throws Exception, ControlFlow {
        ...
        SephObject so = AbstractionCompiler.compile(code, new ArrayList<String>(), LexicalScope.create(null, null, new String[0]), new StaticScope(null), new AbstractionCompiler.SemiStaticScope(new ArrayList<String>(), null), "test");
